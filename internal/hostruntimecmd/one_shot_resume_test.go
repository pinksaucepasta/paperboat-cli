...
func testClientBootstrapMaterial(server string, expiresAt time.Time) bootstrap.Material {
	return bootstrap.Material{
		...
		ExpiresAt: expiresAt, Artifact: &bootstrap.ArtifactTarget{Schema: bootstrap.ArtifactTargetSchemaV1, Kind: bootstrap.ArtifactKindPB, Version: "2026.08.24.1", Platform: runtime.GOOS, Architecture: runtime.GOARCH, RepositoryURL: server, TargetPath: "pb-" + runtime.GOOS + "-" + runtime.GOARCH},
