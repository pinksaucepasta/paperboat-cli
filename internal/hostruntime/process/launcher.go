...
var allowedEnvironment = map[string]bool{
	...
	"PAPERBOAT_PREVIEW_REGISTRATION_ENDPOINT": true, "PAPERBOAT_RUNTIME_AGENT_TOKEN_FILE": true,
	"PAPERBOAT_FILE_TRANSFER_ENDPOINT": true, "PAPERBOAT_FILE_TRANSFER_STAGING_ENDPOINT": true, "PAPERBOAT_WORKSPACE_ROOT": true, "PAPERBOAT_TERMINAL_SESSION_ID": true,
}
