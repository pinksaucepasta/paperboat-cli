...
import (
	...
	"github.com/pinksaucepasta/paperboat/internal/hostruntime/testleak"
)

func admission() connector.Admission {
	return connector.Admission{JTI: "jti_harness_01", Credential: "credential-harness-012345678901234567890123456789", EnvironmentID: "env", MachineID: "helper", ConnectorID: "runtime", Generation: 1, EdgePool: "default", EdgeNodeID: "edge_1", Endpoint: connector.EdgeEndpoint{Host: "edge.test", Port: 7000}, Routes: []connector.RouteHandoff{{RouteID: "route_1", Revision: 1, Kind: "runtime_https_wss", PublicHost: "helper.test", ProxyName: "proxy_1", LocalTarget: connector.RouteTarget{Host: "127.0.0.1", Port: 8080}}}, ProtocolVersion: "1.0", ExpiresAt: time.Now().Add(time.Minute)}
}
