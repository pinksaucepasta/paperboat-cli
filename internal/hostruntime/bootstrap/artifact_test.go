...
func signedArtifact(t *testing.T, serverURL string, artifact []byte) (ArtifactManifest, string) {
	...
	manifest := ArtifactManifest{Schema: ArtifactSchemaV1, Kind: ArtifactKindPB, Version: "0.0.0-development", Platform: runtime.GOOS, Architecture: runtime.GOARCH, URL: serverURL + "/pb", ByteLength: int64(len(artifact)), SHA256: hex.EncodeToString(digest[:])}
...
func signedArtifactPair(t *testing.T, serverURL string) (ArtifactManifest, ArtifactManifest, string) {
	...
	return sign(ArtifactKindPB, "pb", "runtime"), sign(ArtifactKindPB, "pb-copy", "runtime-copy"), base64.RawURLEncoding.EncodeToString(publicKey)
}
