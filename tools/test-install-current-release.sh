...
case "$last" in
  https://release.example/current.json)
    body='{"schema":"paperboat.release-current/v1","version":"2026.08.22.23"}'
    ;;
  https://github.com/example/paperboat-cli/releases/download/2026.08.22.23/pb-linux-amd64)
    body='#!/bin/sh
echo paperboat-test'
    ;;
  https://github.com/example/paperboat-cli/releases/download/2026.08.22.23/SHA256SUMS)
    body='c50bc50bd29910b420d0ce8606bd34caab06e2904bd3f709bce65b2ecb74f1df  pb-linux-amd64'
    ;;
...
grep -qx 'https://github.com/example/paperboat-cli/releases/download/2026.08.22.23/SHA256SUMS' "$temporary/curl.log"
